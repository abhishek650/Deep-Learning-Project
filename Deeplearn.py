...
def main():
    ...
    init= tf.compat.v1.global_variable_initializer()

    saver = tf.compat.v1.train_Saver()
    ...
    training_step = tf.compat.v1.train.GradientDecentOptimizer(learning_rate).minimize(cost_function)
